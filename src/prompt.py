...
Si el jugador se mueve: mover al jugador (hacia un sitio con nombre, nunca null). Si arrastra a alguien, mover a los dos. Lo que no se mueve se queda: no lo describas en el nuevo sitio.
Si aqui.presentes no lista a alguien, no está aquí.
